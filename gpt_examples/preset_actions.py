...
def wave_hands(car):
    car.reset()
    car.set_servo_p1_angle(20)
    for _ in range(2):
        car.set_servo_p2_angle(-25)
        sleep(.1)
        # car.set_servo_p2_angle(0)
        # sleep(.1)
        car.set_servo_p2_angle(25)
        sleep(.1)
    car.set_servo_p2_angle(0)
...
def resist(car):
    car.reset()
    car.set_servo_p1_angle(10)
    for _ in range(3):
        car.set_servo_p2_angle(-15)
        car.set_servo_p0_angle(15)
        sleep(.1)
        car.set_servo_p2_angle(15)
        car.set_servo_p0_angle(-15)
        sleep(.1)
...
def act_cute(car):
    ...
    for i in range(15):
        ...
        car.backward(5)
        sleep(0.02)
    car.set_servo_p1_angle(0)
    car.stop()

def rub_hands(car):
    car.reset()
    for i in range(5):
        car.set_servo_p2_angle(-6)
        sleep(.5)
        car.set_servo_p2_angle(6)
        sleep(.5)
    car.reset()
...
def think(car):
    ...
    for i in range(11):
        car.set_servo_p0_angle(i*3)
        car.set_servo_p1_angle(-i*2)
        car.set_servo_p2_angle(i*2)
        sleep(.05)
    sleep(1)
    car.set_servo_p0_angle(15)
    car.set_servo_p1_angle(-10)
    car.set_servo_p2_angle(10)
    sleep(.1)
    car.reset()
...
def shake_head(car):
    car.stop()
    car.set_servo_p0_angle(0)
    car.set_servo_p0_angle(60)
    sleep(.2)
    car.set_servo_p0_angle(-50)
    sleep(.1)
    car.set_servo_p0_angle(40)
    sleep(.1)
    car.set_servo_p0_angle(-30)
    sleep(.1)
    car.set_servo_p0_angle(20)
    sleep(.1)
    car.set_servo_p0_angle(-10)
    sleep(.1)
    car.set_servo_p0_angle(10)
    sleep(.1)
    car.set_servo_p0_angle(-5)
    sleep(.1)
    car.set_servo_p0_angle(0)
...
def nod(car):
    car.reset()
    car.set_servo_p1_angle(0)
    car.set_servo_p1_angle(5)
    sleep(.1)
    car.set_servo_p1_angle(-30)
    sleep(.1)
    car.set_servo_p1_angle(5)
    sleep(.1)
    car.set_servo_p1_angle(-30)
